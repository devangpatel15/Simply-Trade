...
const { getAllOrganization, getOrganization, createOrganization, updateOrganization, deleteOrganization, getAllUserOrganization, softDeleteOrganization, searchOrganization } = require('../controllers/organization')
...
orgRouter.get("/searchOrg/:text",searchOrganization)
