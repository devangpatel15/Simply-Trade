...
const { getAllCustomer, getCustomer, createCustomer, updateCustomer, deleteCustomer, softDeleteCustomer, searchCustomer, selectCustomer } = require('../controllers/customer')
