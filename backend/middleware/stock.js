...
exports.createValidation = [
  ...
  body("category").isMongoId().notEmpty().withMessage("category in string"),
  body("model").isMongoId().notEmpty().withMessage("model in string"),
  body("device").isMongoId().notEmpty().withMessage("device in string"),
  body("capacity").isMongoId().notEmpty().withMessage("capacity in string"),
...
exports.updateStockValidation = [
  ...
  body("customerPhone").isString().withMessage("customerPhone in string"),
  body("category").isMongoId().optional().withMessage("category in string"),
  body("model").isMongoId().optional().withMessage("model in string"),
  body("device").isMongoId().optional().withMessage("device in string"),
  body("capacity").isMongoId().optional().withMessage("capacity in string"),
